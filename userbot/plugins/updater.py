#"""Update UserBot Code (FOR NEXT-LEVEL USERBOT)
#Syntax: .update
#\nAll Credits goes to © @sameer_795
...
UPSTREAM_REPO_URL = "https://github.com/sameerpanthi/NEXT-LEVEL"
...
async def upstream(ups):
    ...
    if HEROKU_API_KEY is not None:
        ...
        if "heroku" in repo.remotes:
            ...
            await ups.edit("`⬛⬛⬛⬛ \n⬛❇️❇️⬛ \n⬛❇️❇️⬛ \n⬛⬛⬛⬛`")
            await asyncio.sleep(1)
        await ups.edit("`⚜️Updating NEXT-LEVEL BOT⚜️\n\nYou are the 👑KING👑 MASTER!!\n\nPlease wait 5-10 min😁😁\nThen try .alive to check` 😎😎\n\n**create by :-**\n@sameer_795 ")
